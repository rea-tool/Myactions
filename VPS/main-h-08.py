...
try:
    USER_ID_H_02 = os.environ['USER_ID_H_08']
except:
    # 本地调试用
    USER_ID_H_02 = ''

try:
    PASS_WD_H_02 = os.environ['PASS_WD_H_08']
except:
    # 本地调试用
    PASS_WD_H_02 = ''
...
def login():
    ...
    print('- fill user id')
    if USER_ID_H_02 == '':
        print('*** USER_ID_H_02 is empty ***')
        kill_browser()
    else:
        write(USER_ID_H_02, into=S('@username'))
    print('- fill password')
    if PASS_WD_H_02 == '':
        print('*** PASS_WD_H_02 is empty ***')
        kill_browser()
    else:
        write(PASS_WD_H_02, into=S('@password'))
